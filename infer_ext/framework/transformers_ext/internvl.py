...
def InternAttention_naive_attn(self, x):
    ...
    ext_ops.context_attention(q, k, v, start_loc, seq_len, self.num_heads,
                              self.num_heads, attn_mask=attention_mask, attn_qk_scale=None, alibi_slopes=None, attn_output=x)
