execute_process(
    COMMAND ${CMAKE_COMMAND} -E env TORCH_DEVICE_BACKEND_AUTOLOAD=0
        python -c "from torch.utils import cmake_prefix_path; \
...
execute_process(
    COMMAND ${CMAKE_COMMAND} -E env TORCH_DEVICE_BACKEND_AUTOLOAD=0
        python -c "import torch; from packaging import version; \
...
execute_process(
    COMMAND python -c "from packaging import version; \
        from importlib.metadata import distribution; \
        torch_npu_version = version.parse(distribution('torch_npu').version); \
