...
#     p.join()
    ...
    # pipe = lmdeploy.pipeline("/data2/share_data/mixtral_model_data/Mixtral-8x7B-Instruct-v0.1",
    #                         backend_config = PytorchEngineConfig(tp=2, cache_max_entry_count=0.4, device_type="ascend"))
    # assert script
    # assert_pipeline_chat_log(config, common_case_config, model, 'pytorch',
    #                          worker_id)
