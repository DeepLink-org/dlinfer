...
__global__ void gptq_marlin_repack_kernel(uint32_t const* __restrict__ b_q_weight_ptr, uint32_t const* __restrict__ perm_ptr, uint32_t* __restrict__ out_ptr,
...
#define CALL_IF(NUM_BITS, HAS_PERM)                                                                                                                      \
        ...
        cudaFuncSetAttribute(                                                                                                                            \
            marlin::gptq_marlin_repack_kernel<marlin::repack_threads, NUM_BITS, HAS_PERM>, cudaFuncAttributeMaxDynamicSharedMemorySize, max_shared_mem); \
