...
def fused_moe(
    ...
    hidden_states, split_hidden_states, num_tokens, x_active_mask, moe_group_name = (
        moe.moe_prepare(hidden_states, pad_size, tp_size, ep_size, tp_rank, ep_group)
    )
    ...
    elif moe_type == moe.MoeType.ALLTOALL:
    ...
    moe_output = moe.moe_finalize(
        split_hidden_states, moe_output, num_tokens, tp_size, ep_size, tp_group
    )
