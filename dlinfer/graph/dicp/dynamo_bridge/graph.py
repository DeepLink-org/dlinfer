...
class GraphTransformer:
    def __init__(
        ...
        if backend == 'topsgraph':
            from dlinfer.graph.dicp.vendor.TopsGraph.opset_transform import topsgraph_opset_transform
            self.backend_opset_transform = topsgraph_opset_transform
            from dlinfer.graph.dicp.vendor.TopsGraph.codegen.enflame import EnflameCodegen
            self.backend_codegen = EnflameCodegen
        elif backend == 'ascendgraph':
            from dlinfer.graph.dicp.vendor.AscendGraph.opset_convert import ascendgraph_opset_convert
            self.backend_opset_transform = ascendgraph_opset_convert
            from dlinfer.graph.dicp.vendor.AscendGraph.codegen.ascend import AscendCodegen
            self.backend_codegen = AscendCodegen
        elif backend == 'atbgraph':
            from dlinfer.graph.dicp.vendor.AtbGraph.opset_convert import atbgraph_opset_convert
