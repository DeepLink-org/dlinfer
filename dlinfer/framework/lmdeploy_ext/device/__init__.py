...
def patch_gated_delta_net():
    ...
    class AscendGatedDelta:
        ...
        def __init__(self, use_qk_l2norm_in_kernel: bool = True):
            self.fused_sigmoid_gating_delta_rule_update = fused_sigmoid_gating_delta_rule_update
...
def patch_qwen3_5():
    ...
    from lmdeploy.pytorch.models.qwen3_5 import Qwen3_5ForConditionalGeneration, Qwen3_5GatedDeltaNet
    ...
    def custom_weight_loader(self, param: torch.nn.Parameter, loaded_weight: torch.Tensor):
        """Weight loader."""
    ...
    Qwen3_5ForConditionalGeneration.prepare_inputs_for_generation = custom_prepare_inputs_for_generation
